  ...
  return (
    <div className="min-h-screen bg-slate-950 pt-24 relative overflow-hidden">
      ...
      <div className="fixed inset-0 z-0">
        ...
        <div className="absolute top-0 left-0 right-0 h-[500px] bg-linear-to-b from-pink-500/10 via-transparent to-transparent"></div>
        <div className="absolute bottom-0 left-0 right-0 h-[500px] bg-linear-to-t from-rose-900/10 via-transparent to-transparent"></div>
        ...
        <motion.div 
          ...
          className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-rose-900/20 rounded-full blur-[128px]"
        />
      </div>
