  ...
  return (
    <div className="min-h-screen bg-slate-950 pt-24 relative overflow-hidden">
      ...
      <div className="fixed inset-0 z-0">
        ...
        <div className="absolute top-0 left-0 right-0 h-[300px] bg-linear-to-b from-corporate-primary/5 via-transparent to-transparent"></div>
        ...
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-corporate-primary/10 rounded-full blur-[80px]" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-lab-primary/10 rounded-full blur-[80px]" />
      </div>
