    ...
    <div className="min-h-screen bg-slate-950 text-white selection:bg-lab-primary/20 selection:text-white relative">
      ...
      <div className="relative z-10">
          ...
          <div className="container mx-auto max-w-7xl relative z-10">
            <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
              ...
              >
                ...
                <h1 className="text-6xl lg:text-8xl font-bold tracking-tight leading-[1.05] mb-10">
                  <span className="bg-clip-text text-transparent bg-gradient-to-br from-white to-slate-400">
                    Build. Secure.{' '}
                  </span>
                  <span className="text-lab-primary relative">
                    Transform.
                    <svg className="absolute -bottom-2 left-0 w-full h-3 text-lab-accent/40" viewBox="0 0 100 10" preserveAspectRatio="none">
                      <path d="M0 5 Q 25 0 50 5 T 100 5" fill="none" stroke="currentColor" strokeWidth="4" />
                    </svg>
                  </span>
                </h1>
                
                <p className="text-xl lg:text-2xl text-slate-400 mb-12 leading-relaxed max-w-3xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 gap-6">
                          {stats.map((stat, i) => (
                            <motion.div 
                              ...
                              className="p-8 rounded-2xl border border-slate-800 bg-slate-900/50 hover:border-lab-primary/20 hover:bg-lab-primary/5 transition-all group"
                            >
          ...
          <div className="container mx-auto max-w-7xl relative z-10">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
              <div className="max-w-2xl">
                ...
                <h2 className="text-4xl lg:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-br from-white to-slate-400 mb-6 tracking-tight">
        ...
        <motion.section 
          ...
          viewport={{ once: true, margin: "-100px" }}
          transition={{ duration: 1 }}
          className="py-32 px-4 text-white overflow-hidden relative"
        >
          <div className="container mx-auto max-w-7xl relative z-10">
            <div className="text-center max-w-3xl mx-auto mb-24">
              <Badge className="mb-6 bg-lab-primary/20 text-lab-primary border-lab-primary/30 px-4 py-1">The Ecosystem</Badge>
              <h2 className="text-4xl lg:text-6xl font-bold mb-8 tracking-tight bg-clip-text text-transparent bg-gradient-to-br from-white to-slate-400">
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              <div className="space-y-10">
                <motion.div 
                  ...
                  className="p-10 rounded-[2rem] bg-white/5 border border-white/10 backdrop-blur-md hover:bg-white/10 transition-all group relative overflow-hidden"
                >
              ...
              <div className="relative lg:pl-12">
                <div className="aspect-square rounded-full border border-white/10 flex items-center justify-center relative">
                  ...
                  <div className="w-4/5 h-4/5 rounded-full border border-white/5 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm">
          ...
          <div className="container mx-auto max-w-7xl">
            <div className="grid lg:grid-cols-2 gap-24 items-center">
              ...
              >
                ...
                <h2 className="text-5xl lg:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-br from-white to-slate-400 mb-8 tracking-tight leading-[1.1]">
              ...
              <motion.div
                ...
                className="relative"
              >
                <div className="bg-corporate-primary rounded-[3rem] p-6 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.3)] overflow-hidden">
                        ...
                        <div key={i} className="space-y-4">
                          ...
                          <div className="h-3 w-full bg-white/10 rounded-full overflow-hidden">
                            <motion.div 
                              ...
                              className={`h-full ${metric.color} rounded-full shadow-[0_0_15px_rgba(0,0,0,0.5)]`} 
                            />
                          </div>
                        </div>
                      ))}
            ...
            <div className="grid md:grid-cols-3 gap-12 relative">
              ...
              {[
                ...
                <motion.div 
                  ...
                  className="relative z-10 bg-slate-900/50 backdrop-blur-sm p-10 rounded-3xl border border-slate-800 shadow-sm hover:shadow-xl hover:border-lab-primary/20 transition-all group"
                >
        ...
        <motion.section 
          ...
          viewport={{ once: true }}
          transition={{ duration: 1 }}
          className="py-24 px-4 border-y border-slate-800 overflow-hidden"
        >
          <div className="container mx-auto max-w-7xl">
